...
class NoticiasControllerTest < ActionController::TestCase
  ...
  test "should create noticia" do
    assert_difference('Noticia.count') do
      post :create, noticia: { contenido: @noticia.contenido, estado: @noticia.estado, foto_portada: @noticia.foto_portada, slug: @noticia.slug, titulo: @noticia.titulo }
    end
  ...
  test "should update noticia" do
    patch :update, id: @noticia, noticia: { contenido: @noticia.contenido, estado: @noticia.estado, foto_portada: @noticia.foto_portada, slug: @noticia.slug, titulo: @noticia.titulo }
    assert_redirected_to noticia_path(assigns(:noticia))
  end
